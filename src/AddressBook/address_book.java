...
public class AddressBook {
	...
	private static File file = new File("C:\\User\\Dell\\ecplise-workshop\\Day28\\src\\main\\addressBook\\Contact.csv");
	 ...
	 private static void showMainMenu() throws IOException {
	        ...
	        do {
	            ...
	            switch (choice) {
	                ...
	                case "2":
	                	readPeopleFromFile("C:\\User\\Dell\\ecplise-workshop\\Day28\\src\\main\\addressBook\\Contact.csv");
	                    showMainMenu();
	                    break;
	                case "0":
	                    System.exit(0);
